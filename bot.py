...
def generate_content_with_deepseek(topic):
    ...
    prompt = f"""You are both an expert consultant on the topic given and an English language teaching assistant. Create informationally highly insightful and nuanced learning materials with expert advice about the topic: "{topic}"

Please generate a JSON response with the following structure:
{{
  "main_text": "An engaging and expertly insightful English text at CEFR B2/weak C1 level about {topic}. Should be 200-250 words long, must contain expert-level insights / information, should be natural. MUST contain relevant terminology and 3 phrasal verbs that are either typical for this context OR generically useful. Include the objects with phrasal verbs (e.g., 'pick up a language', 'look after children').",
  "collocations": [
  ...
  "opinion_texts": {{
    "positive": "A natural English response (B2/C1 level, 80-120 words) adding extra expert insights to the main topic. Must incorporate some vocabulary from the collocations list naturally.",
    "negative": "A natural English response (B2/C1 level, 80-120 words) giving contrasting expert insights to the main topic. Must incorporate some vocabulary from the collocations list naturally.",
    "mixed": "A natural English response (B2/C1 level, 80-120 words) giving a balanced/mixed reaction to the main topic. Must incorporate some vocabulary from the collocations list naturally."
  }},
  "discussion_questions": [
    "Question 1 in English (B2/C1 level) - should ask about personal reaction to presented insights",
    "Question 2 in English (B2/C1 level) - should ask about personal experience in reference to the topic",
    "Question 3 in English (B2/C1 level) - should encourage reflection nuances in the differences in the insights",
...
3. The first 3 collocations MUST be the phrasal verbs
...
5. REaction texts must  naturally use some collocations but sound expert and insightful
